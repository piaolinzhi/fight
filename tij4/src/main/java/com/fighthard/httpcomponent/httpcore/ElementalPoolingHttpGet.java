 ...
 */
package com.fighthard.httpcomponent.httpcore;
...
/**
 * Elemental example for executing multiple GET requests from different threads
...
public class ElementalPoolingHttpGet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final BasicConnPool pool = new BasicConnPool(
                new BasicConnFactory());
        pool.setDefaultMaxPerRoute(2);
        pool.setMaxTotal(2);

        HttpHost[] targets = { new HttpHost("www.baidu.com", 80),
                new HttpHost("www.taobao.com", 80),
